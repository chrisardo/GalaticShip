...
public class Ayuda2Activity extends AppCompatActivity {
    ...
    int desbloquear1, desbloquear2, ayuda2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ayuda2= getIntent().getIntExtra("Ayuda2",0);
    ...
    public void volver(View view){
        if (ayuda2 == 2){
            Intent inte= new Intent(getApplicationContext(), UniverseoActivity.class);
            inte.putExtra("desbloquearNivel1", desbloquear1);
            inte.putExtra("desbloquearNivel2", desbloquear2);
            startActivity(inte);
        }else {
            Intent inte= new Intent(getApplicationContext(), ActivityJuego2.class);
            inte.putExtra("desbloquearNivel1", desbloquear1);
            inte.putExtra("desbloquearNivel2", desbloquear2);
            startActivity(inte);
        }
